...
channel_3 = int(os.environ.get("CHANNEL_3", "-1001892588505"))
channel_4 = int(os.environ.get("CHANNEL_4", "-1001884106616"))
...
Silahkan join ke @NekoMenfess dan coba lagi dengan mengetik atau klik /start""")
